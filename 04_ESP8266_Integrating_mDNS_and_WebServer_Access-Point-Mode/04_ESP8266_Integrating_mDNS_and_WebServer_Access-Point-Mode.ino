...
#include <ESP8266WebServer.h> // Include the HTTP server library
...
void handleRoot() {
  server.send(200, "text/plain", "Hello, World!");  // Send a simple response
}
...
void setup() {
  ...
  // Define the root path for the server
